...
def get_trade_list(file_type = "csv", component = "500", export_path = path_ + r"/Trades_to_take"):
    table = pd.read_html(f'https://en.wikipedia.org/wiki/List_of_S%26P_{component}_companies')
    df = table[0]
